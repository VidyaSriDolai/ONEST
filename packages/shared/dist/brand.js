...
export const BRAND = {
    ...
    description: 'An ONEST-compliant certification platform for corporate training providers. Enroll learners, run assessments, issue tamper-evident certificates, and let any employer verify them instantly.',
